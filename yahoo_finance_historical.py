...
def parse(ticker):
    ...
    try:
        ...
        summary_table = parser.xpath('//*[@id="Col1-0-KeyStatistics-Proxy"]/section/div/div/div/div/table/tbody/tr')
        ## //*[@id="Col1-0-KeyStatistics-Proxy"]/section/div[2]/div[1]/div[1]/div/table/tbody/tr[1]
